                                ...
                                <div class="col">
                                    <div class="card card-wrapper my-2"
                                        ...
                                        <a href="home/create" class="card-body card-self py-5"
                                            ...
                                            <h5 class="card-title"
                                                style="font-size: 20px; font-weight:bold; color:black;">Tambah Data
                                ...
                                <div class="col">
                                    <div class="card card-wrapper my-2"
                                        ...
                                        <a href="/crudrenstra" class="card-body card-self py-5"
                                            style="border-radius:15px; width:auto; height:auto; text-decoration: none;">
                                            <h5 class="card-title" style="font-size: 20px; font-weight:bold;">Tambah
                                                Data Rencana Kegiatan</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
...
@else
    ...
    <body style="background: #F8FAFB;" onload="toasty()">
        @include('partials.navbar')
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 50%; border-radius:20px;">
                <div class="modal-content">
