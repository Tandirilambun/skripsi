                                    ...
                                    <div class="progress">
                                        <div class="progress_item">
                                            ...
                                            <div class="progress_bar">
                                                <div class="bar" data-value="{{ $avg_capaian }}"
                                                    data-text="{{ $avg_capaian }}"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col card shadow-sm" style=" width:auto; border-color: transparent;">
                                <div class="card-body" id="card-body">
                                    ...
                                    <div class="container container-chart"
                                        ...
                                        <div class="circular-progress" id="circular-progress-{{ $capaian->id_capaian }}"
                                            data-id={{ $capaian->id_capaian }}>
                                            <div class="value-container" id="value-container-{{ $capaian->id_capaian }}"
                                                data-id={{ $capaian->id_capaian }}> {{ $capaian->capaian }} </div>
                                        </div>
                                    </div>
                                    <!--Detail Information-->
                                ...
                                <button type="button" class="btn btn-details" data-bs-toggle="popover"
                                    data-bs-trigger="focus" data-bs-placement="bottom"
                                    data-bs-title="Capaian dalam {{ $capaian->tahun }}"
                                    data-bs-content="{{ $capaian->hasil }}">Hasil Capaian</button>
                            </div>
                        @endforeach
                    </div>
                @else
