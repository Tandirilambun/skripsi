                    ...
                    <div class="progress">
                        <div class="progress_item">
                            ...
                            <div class="progress_bar">
                                <div class="bar" data-value="{{ round($avg) }}" data-text="{{ round($avg) }}"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="overview-list m-3 border px-3 py-1">
                        <div class="row" style="gap:1%">
                            ...
                            <div class="col btn-action px-0"
                                ...
                                <a href="/indikator/{{ $ind -> id_indikator }}" class="btn"
                                    style="background-color:#0096FF;">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="#" class="btn" data-bs-toggle="modal"
                                    data-bs-target="#editIndOutcomesModal" style="background-color: #FFBF00">
                                    <i class="bi bi-pen"></i>
                                </a>
                                <form action="/indikator/{{ $ind -> id_indikator }}" method="post">
                                    @csrf
                                    @method('delete')
