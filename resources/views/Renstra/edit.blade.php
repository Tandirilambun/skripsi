    ...
    <div class="container py-5">
        <nav>
            <div class="nav nav-tabs tabsNav" id="nav-tab" role="tablist">
                <button class="nav-link active btnNav" id="nav-periode-tab" data-bs-toggle="tab" data-bs-target="#nav-periode"
                    type="button" role="tab" aria-controls="nav-periode" aria-selected="true">Periode</button>
                <button class="nav-link btnNav" id="nav-goal-tab" data-bs-toggle="tab" data-bs-target="#nav-goal"
                    type="button" role="tab" aria-controls="nav-goal" aria-selected="false">Goal</button>
                <button class="nav-link btnNav" id="nav-outcomes-tab" data-bs-toggle="tab" data-bs-target="#nav-outcomes"
                    type="button" role="tab" aria-controls="nav-outcomes" aria-selected="false">Outcomes</button>
                <button class="nav-link btnNav" id="nav-outputs-tab" data-bs-toggle="tab" data-bs-target="#nav-outputs"
                    type="button" role="tab" aria-controls="nav-outputs" aria-selected="false">Outputs</button>
        ...
        <div class="card card-container pb-3 shadow-sm" style="border-radius:0 0 20px 20px; border-color: transparent;">
            ...
            <div class="tabs">
                <div class="tab-content" id="nav-tabContent">
                    <!--Periode-->
                    <div class="tab-pane fade show active" id="nav-periode" role="tabpanel"
                        aria-labelledby="nav-periode-tab">
                                ...
                                <div class="mb-3" style="display:flex; gap:4%;">
                                    ...
                                    <select class="form-select " aria-label="Default select example" style="width: auto"
                                        ...
                                        @foreach ($periodes as $period)
                                            <option value="{{ $period->id_periode }}"> {{ $period->roadmap }}
                                                ({{ $period->tahun_awal }} - {{ $period->tahun_akhir }}) </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3" style="display:flex; gap:4%;">
                            ...
                            <form method="POST" action="/home">
                                <div class="mb-3" style="display:flex; gap:5%; clear:both">
                                    ...
                                    <select required class="form-select " aria-label="Default select example"
                                        style="width: auto" name="selectGoal">
                                ...
                                <div class="mb-3" style="display:flex; gap:5%;">
                                    ...
                                    <textarea required class="form-control " id="inputOutcomes" aria-label="With textarea" style="width: 80%;"
                                        name="inputOutcomes"></textarea>
                                </div>
                                <button type="submit" class="btn btn-primary">Add Data</button>
                            </form>
                        </div>
                        ...
                        <div class="container p-3">
                            <form method="POST" action="/home">
                                ...
                                <div class="mb-3" style="display:flex; gap:5%;">
                                    ...
                                    <textarea class="form-control " id="inputOutputs" aria-label="With textarea" style="width: 80%;"
                                        name="inputOutputs"></textarea>
                                </div>
                                <button type="submit" class="btn btn-primary">Add Data</button>
                            </form>
                        </div>
                                ...
                                <div class="mb-3" style="display:flex; gap:5%; clear:both">
                                    ...
                                    <select class="form-select " aria-label="Default select example" style="width: 90%"
                                        ...
                                        @foreach ($outcomes as $outcome)
                                            <option value="{{ $outcome->id_outcomes }}">
                                                {{ $outcome->strategi_outcome }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3" style="display:flex; gap:5%; clear:both">
                                    ...
                                    <select class="form-select " aria-label="Default select example" style="width: 90%"
                                        ...
                                        @foreach ($outputs as $output)
                                            <option value="{{ $output->id_outputs }}">
                                                {{ $output->strategi_outputs }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3" style="display:flex; gap:5%;">
                                    <label for="inputIndikator">Indikator</label>
                                    <textarea class="form-control " id="inputIndikator" aria-label="With textarea" style="width: 90%;"
                                        name="inputIndikator"></textarea>
                                </div>
                                <div class="mb-3" style="display:flex; gap:5%;">
                                    <label for="inputIndikatorNumerik">Indikator Numerik</label>
                                    <input type="number" class="form-control" id="inputIndikatorNumerik"
                                        name="inputIndikatorNumerik" style="width: 90%;">
                                </div>
                                <button type="submit" class="btn btn-primary">Add Data</button>
                            </form>
                        </div>
