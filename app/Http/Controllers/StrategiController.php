...
class StrategiController extends Controller
{
    ...
    public function store(Request $request)
    {
        return ($request);
        Strategi::create([
            'id_goal' => $request-> selectPeriode,
            'id_jenis' => $request -> selectJenis ,
            'deskripsi_strategi' => $request -> inputStrategi
        ]) -> save();
        return redirect('/home') -> with('success', 'Strategi has been stored successfully');
    }
